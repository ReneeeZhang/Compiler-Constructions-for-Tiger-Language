...
datatype instr = OPER of {assem: string,
			  dst: temp list,
			  src: temp list,
			  jump: label list option}  (* An OPER holds an assembly-language instruction assem; Operations that always fall through to the next instruction have jump=NONE; *)
